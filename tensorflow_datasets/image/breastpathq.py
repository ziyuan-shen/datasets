...
_DESCRIPTION = """
The dataset's training/validation set consists of 2578 patches extracted from
96 breast cancer whole slide images (WSI). Each patch is labelled by a tumor
cellularity score. The testing set contains 1121 patches from 25 WSIs. Labels
for testing data are not provided by far. The dataset can be used to develop
an automated method for evaluating cancer cellularity from histology patches
extracted from WSIs. The method is aimed to increase reproducibility of cancer
    ...
    def _generate_examples(self, images_dir_path, labels):
        ...
        with tf.io.gfile.GFile(labels, "r") as f:
            ...
            for row in dataset:
                ...
                yield image_id, {
                    "image": _load_tif(os.path.join(images_dir_path,
                                                    image_id+'.tif')),
                    'label': row['y'],
                }
